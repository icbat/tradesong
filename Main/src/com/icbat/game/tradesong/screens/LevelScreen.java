...
public class LevelScreen extends AbstractScreen {
    ...
    private OrthographicCamera rendererCamera;
    private final OrthographicCamera gameWorldCamera;
...
//    private Texture background = Tradesong.getTexture(TextureAssets.SKY);
    ...
    public LevelScreen(String level, Tradesong gameInstance) {
        ...
        // Set up cameras
        rendererCamera = new OrthographicCamera(width, height);
        gameWorldCamera = new OrthographicCamera(width, height);
