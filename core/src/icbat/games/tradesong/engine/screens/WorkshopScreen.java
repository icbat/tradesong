...
import icbat.games.tradesong.engine.screens.components.BuyWorkersButton;
...
public class WorkshopScreen extends AbstractBaseScreen {
    ...
    protected Table buildCentralLayout() {
        ...
        layout.add(new BuyWorkersButton(workshop, TradesongGame.holdings.getSpareWorkers())).pad(15);
